...
import { useConfirmModal } from "@/components/layout/confirm-modal";
  ...
  const handleRemoveArea = (areaId: string) => {
    if (Qualificacao.length === 1) {
      setTimeout(() => {
        limparConsultores();
        toast.warning(
          "Removido todas as áreas. Os Consultores foram removidos"
        );
      }, 500);
    }
    removerArea(areaId);
              ...
              <Button
                ...
                onClick={async (e) => {
                  ...
                  const ok = await confirm({
                    title: "Remover área?",
                    description:
                      "Isso não pode ser desfeito. A área e seus documentos serão removidos.",
                    confirmText: "Remover",
                    cancelText: "Cancelar",
                    destructive: true,
                  });
                      ...
                      <Dialog>
                        ...
                        <DialogContent>
                          ...
                          <DialogDescription>
                            ...
                            Você precisará recadastrar todos os documentos da
                            área novamente.
                          </DialogDescription>
                          <DialogFooter>
                            <Button
                ...
                <DialogFooter>
                  <Button
                    ...
                    onClick={() => {
                      setOpen(false);
                      toast.success(
                        "Informaçoes da área inseridas com sucesso!"
                      );
                    }}
                    disabled={
                      Object.keys(form.formState.errors).length > 0 ||
